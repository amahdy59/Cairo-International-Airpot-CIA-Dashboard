              ...
              {jumpScenes.map((scene) => {
                ...
                return (
                  <button
                    ...
                    className={`inline-flex min-h-[44px] shrink-0 items-center justify-center rounded-xl border px-3 sm:px-4 text-xs lg:text-sm font-semibold transition-all duration-200 active:scale-95 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary cursor-pointer ${
