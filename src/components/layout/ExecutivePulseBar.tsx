...
import { ShieldCheck, Activity, Plane, Users, ChevronDown, ChevronUp } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center justify-between gap-2.5">
        {/* Left: Operational Status & Runways */}
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 ms-auto">
          <button
            ...
            className="flex items-center gap-1.5 rounded-xl border border-primary/40 bg-primary/15 px-3 py-1.5 text-xs font-semibold text-primary transition-all duration-200 hover:bg-primary/25 hover:border-primary active:scale-95 cursor-pointer"
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-xl border border-border bg-secondary/30 px-3 py-1.5 text-xs font-semibold text-foreground transition-all duration-200 hover:bg-secondary hover:text-foreground active:scale-95 cursor-pointer"
          ...
          <button
            ...
            className="grid h-8 w-8 place-items-center rounded-xl border border-border bg-secondary/30 text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground active:scale-95 cursor-pointer"
